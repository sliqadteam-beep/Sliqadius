...
function isVerifiedPhone(p){return String(p||'').replace(/[\s().-]/g,'')===VERIFIED_PHONE}
...
#people{overflow-anchor:none!important;contain:layout paint}.q26row,.q306groupRow{transform:none!important;will-change:auto!important}
...
@media(max-width:350px){.q308profileChip{max-width:150px}.q308miniInfo{max-width:96px}.q308miniPhone{display:block!important;font-size:8.5px}}
