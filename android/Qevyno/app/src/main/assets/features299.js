(()=>{
  ...
  const T={
    en:{name:'Skaysa Help',preview:'Help with using Skaysa',intro:'Welcome to Skaysa Help. This is a built-in help contact.',start:'Start a chat: tap + and enter the other person’s phone number without a country code.',qr:'QR code: open + or Settings to show your QR code. Someone else can scan it to start a chat with you.',msg:'Messages: press and hold a message to add a reaction or delete it.',profile:'Profile: open the three-dot menu and Settings to change your profile picture. A purple check means the person is verified.',privacy:'Privacy: your chat history is stored on your device, not permanently on the Skaysa server.',blocked:'You cannot write to this number.'},
    de:{name:'Skaysa Hilfe',preview:'Hilfe zur Bedienung von Skaysa',intro:'Willkommen bei der Skaysa Hilfe. Dies ist ein integrierter Hilfe-Kontakt.',start:'Chat starten: Tippe auf + und gib die Telefonnummer der anderen Person ohne Ländervorwahl ein.',qr:'QR-Code: Öffne + oder die Einstellungen, um deinen QR-Code anzuzeigen. Andere können ihn scannen und direkt einen Chat mit dir starten.',msg:'Nachrichten: Halte eine Nachricht gedrückt, um eine Reaktion hinzuzufügen oder sie zu löschen.',profile:'Profil: Öffne das Drei-Punkte-Menü und die Einstellungen, um dein Profilbild zu ändern. Ein lila Haken bedeutet, dass die Person verifiziert ist.',privacy:'Privatsphäre: Dein Chatverlauf wird auf deinem Gerät gespeichert und nicht dauerhaft auf dem Skaysa-Server.',blocked:'Du kannst nicht mit dieser Nummer schreiben.'},
    es:{name:'Ayuda de Skaysa',preview:'Ayuda para usar Skaysa',intro:'Bienvenido a la ayuda de Skaysa. Este es un contacto de ayuda integrado.',start:'Iniciar un chat: pulsa + e introduce el número de la otra persona sin prefijo internacional.',qr:'Código QR: abre + o Ajustes para mostrar tu QR. Otra persona puede escanearlo para iniciar un chat contigo.',msg:'Mensajes: mantén pulsado un mensaje para añadir una reacción o eliminarlo.',profile:'Perfil: abre el menú de tres puntos y Ajustes para cambiar tu foto. Un check morado significa que la persona está verificada.',privacy:'Privacidad: tu historial se guarda en tu dispositivo y no de forma permanente en el servidor de Skaysa.',blocked:'No puedes escribir a este número.'},
    fr:{name:'Aide Skaysa',preview:'Aide pour utiliser Skaysa',intro:'Bienvenue dans l’aide Skaysa. Ceci est un contact d’aide intégré.',start:'Démarrer une discussion : appuie sur + et saisis le numéro de l’autre personne sans indicatif international.',qr:'Code QR : ouvre + ou les Paramètres pour afficher ton QR. Une autre personne peut le scanner pour démarrer une discussion avec toi.',msg:'Messages : maintiens un message appuyé pour ajouter une réaction ou le supprimer.',profile:'Profil : ouvre le menu à trois points puis Paramètres pour changer ta photo. Une coche violette signifie que la personne est vérifiée.',privacy:'Confidentialité : ton historique est stocké sur ton appareil et non en permanence sur le serveur Skaysa.',blocked:'Tu ne peux pas écrire à ce numéro.'},
    it:{name:'Aiuto Skaysa',preview:'Aiuto per usare Skaysa',intro:'Benvenuto nell’aiuto Skaysa. Questo è un contatto di assistenza integrato.',start:'Avvia una chat: tocca + e inserisci il numero dell’altra persona senza prefisso internazionale.',qr:'Codice QR: apri + o Impostazioni per mostrare il tuo QR. Un’altra persona può scansionarlo per avviare una chat con te.',msg:'Messaggi: tieni premuto un messaggio per aggiungere una reazione o eliminarlo.',profile:'Profilo: apri il menu con tre punti e Impostazioni per cambiare la foto. Una spunta viola indica che la persona è verificata.',privacy:'Privacy: la cronologia chat viene salvata sul dispositivo e non in modo permanente sul server Skaysa.',blocked:'Non puoi scrivere a questo numero.'},
    pt:{name:'Ajuda Skaysa',preview:'Ajuda para usar o Skaysa',intro:'Bem-vindo à ajuda do Skaysa. Este é um contacto de ajuda integrado.',start:'Iniciar conversa: toca em + e introduz o número da outra pessoa sem indicativo internacional.',qr:'Código QR: abre + ou Definições para mostrar o teu QR. Outra pessoa pode digitalizá-lo para iniciar uma conversa contigo.',msg:'Mensagens: mantém uma mensagem premida para adicionar uma reação ou apagá-la.',profile:'Perfil: abre o menu de três pontos e Definições para mudar a foto. Um visto roxo significa que a pessoa está verificada.',privacy:'Privacidade: o histórico fica guardado no teu dispositivo e não permanentemente no servidor Skaysa.',blocked:'Não podes escrever para este número.'},
    nl:{name:'Skaysa Help',preview:'Hulp bij het gebruik van Skaysa',intro:'Welkom bij Skaysa Help. Dit is een ingebouwd hulpcontact.',start:'Chat starten: tik op + en voer het telefoonnummer van de andere persoon in zonder landcode.',qr:'QR-code: open + of Instellingen om je QR-code te tonen. Iemand anders kan hem scannen om een chat met jou te starten.',msg:'Berichten: houd een bericht ingedrukt om een reactie toe te voegen of het te verwijderen.',profile:'Profiel: open het driepuntsmenu en Instellingen om je profielfoto te wijzigen. Een paars vinkje betekent dat de persoon geverifieerd is.',privacy:'Privacy: je chatgeschiedenis staat op je apparaat en niet permanent op de Skaysa-server.',blocked:'Je kunt niet naar dit nummer schrijven.'},
    pl:{name:'Pomoc Skaysa',preview:'Pomoc w obsłudze Skaysa',intro:'Witamy w pomocy Skaysa. To wbudowany kontakt pomocy.',start:'Rozpocznij czat: dotknij + i wpisz numer drugiej osoby bez prefiksu kraju.',qr:'Kod QR: otwórz + lub Ustawienia, aby pokazać swój kod QR. Inna osoba może go zeskanować i rozpocząć z Tobą czat.',msg:'Wiadomości: przytrzymaj wiadomość, aby dodać reakcję lub ją usunąć.',profile:'Profil: otwórz menu z trzema kropkami i Ustawienia, aby zmienić zdjęcie. Fioletowy znaczek oznacza, że osoba jest zweryfikowana.',privacy:'Prywatność: historia czatu jest zapisywana na urządzeniu, a nie na stałe na serwerze Skaysa.',blocked:'Nie możesz pisać na ten numer.'},
    tr:{name:'Skaysa Yardım',preview:'Skaysa kullanımı için yardım',intro:'Skaysa Yardım’a hoş geldin. Bu, uygulamaya yerleşik bir yardım kişisidir.',start:'Sohbet başlat: + düğmesine dokun ve diğer kişinin numarasını ülke kodu olmadan gir.',qr:'QR kodu: QR kodunu göstermek için + veya Ayarlar’ı aç. Başka biri kodu tarayarak seninle sohbet başlatabilir.',msg:'Mesajlar: tepki eklemek veya silmek için bir mesaja basılı tut.',profile:'Profil: profil resmini değiştirmek için üç nokta menüsünü ve Ayarlar’ı aç. Mor onay işareti kişinin doğrulandığını gösterir.',privacy:'Gizlilik: sohbet geçmişin cihazında saklanır, Skaysa sunucusunda kalıcı olarak tutulmaz.',blocked:'Bu numaraya mesaj gönderemezsin.'},
    uk:{name:'Допомога Skaysa',preview:'Допомога з використання Skaysa',intro:'Ласкаво просимо до довідки Skaysa. Це вбудований контакт допомоги.',start:'Почати чат: натисни + і введи номер іншої людини без коду країни.',qr:'QR-код: відкрий + або Налаштування, щоб показати свій QR. Інша людина може відсканувати його та почати чат з тобою.',msg:'Повідомлення: затисни повідомлення, щоб додати реакцію або видалити його.',profile:'Профіль: відкрий меню з трьома крапками та Налаштування, щоб змінити фото. Фіолетова позначка означає, що особу підтверджено.',privacy:'Приватність: історія чату зберігається на твоєму пристрої, а не постійно на сервері Skaysa.',blocked:'Ти не можеш писати на цей номер.'},
    ru:{name:'Помощь Skaysa',preview:'Помощь по использованию Skaysa',intro:'Добро пожаловать в помощь Skaysa. Это встроенный справочный контакт.',start:'Начать чат: нажмите + и введите номер другого человека без кода страны.',qr:'QR-код: откройте + или Настройки, чтобы показать свой QR. Другой человек может отсканировать его и начать чат с вами.',msg:'Сообщения: удерживайте сообщение, чтобы добавить реакцию или удалить его.',profile:'Профиль: откройте меню с тремя точками и Настройки, чтобы изменить фото. Фиолетовая галочка означает, что человек подтверждён.',privacy:'Конфиденциальность: история чата хранится на вашем устройстве, а не постоянно на сервере Skaysa.',blocked:'Вы не можете писать на этот номер.'},
    ja:{name:'Skaysa ヘルプ',preview:'Skaysa の使い方',intro:'Skaysa ヘルプへようこそ。これはアプリ内のヘルプ用連絡先です。',start:'チャットを開始するには、+ をタップして相手の電話番号を国番号なしで入力します。',qr:'QRコード: + または設定から自分のQRコードを表示できます。相手がスキャンするとあなたとのチャットを開始できます。',msg:'メッセージ: 長押しするとリアクションの追加や削除ができます。',profile:'プロフィール: 3点メニューから設定を開いてプロフィール画像を変更できます。紫のチェックは認証済みの相手を示します。',privacy:'プライバシー: チャット履歴は端末に保存され、Skaysaサーバーには永久保存されません。',blocked:'この番号にはメッセージを送信できません。'},
    ko:{name:'Skaysa 도움말',preview:'Skaysa 사용 도움말',intro:'Skaysa 도움말입니다. 앱에 기본으로 포함된 도움말 연락처입니다.',start:'채팅 시작: +를 누르고 상대방의 전화번호를 국가번호 없이 입력하세요.',qr:'QR 코드: + 또는 설정에서 내 QR 코드를 표시할 수 있습니다. 다른 사람이 스캔하면 나와 채팅을 시작할 수 있습니다.',msg:'메시지: 메시지를 길게 눌러 반응을 추가하거나 삭제할 수 있습니다.',profile:'프로필: 점 3개 메뉴의 설정에서 프로필 사진을 바꿀 수 있습니다. 보라색 체크는 인증된 사람을 뜻합니다.',privacy:'개인정보: 채팅 기록은 기기에 저장되며 Skaysa 서버에 영구 저장되지 않습니다.',blocked:'이 번호로는 메시지를 보낼 수 없습니다.'},
    zh:{name:'Skaysa 帮助',preview:'Skaysa 使用帮助',intro:'欢迎使用 Skaysa 帮助。这是应用内置的帮助联系人。',start:'开始聊天：点击 +，输入对方的电话号码，不需要国家区号。',qr:'二维码：打开 + 或设置即可显示你的二维码。其他人扫描后可直接与你开始聊天。',msg:'消息：长按消息可以添加表情反应或删除消息。',profile:'个人资料：打开三点菜单和设置即可更换头像。紫色勾表示该用户已验证。',privacy:'隐私：聊天记录保存在你的设备上，不会永久保存在 Skaysa 服务器。',blocked:'你不能向这个号码发送消息。'},
    ar:{name:'مساعدة Skaysa',preview:'مساعدة في استخدام Skaysa',intro:'مرحبًا بك في مساعدة Skaysa. هذا جهة اتصال مساعدة مدمجة في التطبيق.',start:'لبدء محادثة: اضغط + وأدخل رقم هاتف الشخص الآخر بدون رمز الدولة.',qr:'رمز QR: افتح + أو الإعدادات لعرض رمزك. يمكن لشخص آخر مسحه لبدء محادثة معك.',msg:'الرسائل: اضغط مطولًا على الرسالة لإضافة تفاعل أو حذفها.',profile:'الملف الشخصي: افتح قائمة النقاط الثلاث ثم الإعدادات لتغيير الصورة. علامة الصح البنفسجية تعني أن الشخص موثّق.',privacy:'الخصوصية: يتم حفظ سجل المحادثة على جهازك وليس بشكل دائم على خادم Skaysa.',blocked:'لا يمكنك الكتابة إلى هذا الرقم.'}
  };
  ...
  style.textContent=`
    .q299helpRow{cursor:pointer!important;background:#f8ffff!important}.q299helpRow .q26avatar{background:none!important;color:transparent!important;font-weight:800!important;overflow:hidden!important;padding:0!important}.q299helpRow .q26avatar svg{display:block!important;width:100%!important;height:100%!important}.q299helpRow .q26preview{color:#60747d!important}.q299helpRow .q299tag{font-size:10px;font-weight:700;color:#159fa3;background:#e4f8f8;border-radius:999px;padding:3px 6px;white-space:nowrap}
  ...
  function helpRow(){
    ...
    row.innerHTML='<div class=\"q26avatar q299rootLogo\"><svg viewBox=\"0 0 108 108\" aria-hidden=\"true\"><defs><linearGradient id=\"sk299g\" x1=\"8\" y1=\"7\" x2=\"100\" y2=\"103\" gradientUnits=\"userSpaceOnUse\"><stop offset=\"0\" stop-color=\"#D8F1FF\"/><stop offset=\".48\" stop-color=\"#78B8F3\"/><stop offset=\"1\" stop-color=\"#4D70D2\"/></linearGradient></defs><rect x=\"4\" y=\"4\" width=\"100\" height=\"100\" rx=\"24\" fill=\"url(#sk299g)\"/><path d=\"M77 30C69 22 57 19 46 22C35 25 29 32 30 40C31 48 39 52 51 55L61 58C72 61 79 66 78 75C77 83 68 89 56 90C44 91 33 87 25 80\" fill=\"none\" stroke=\"#fff\" stroke-width=\"8\" stroke-linecap=\"round\" stroke-linejoin=\"round\"/><path d=\"M85 16L88 22L94 25L88 28L85 34L82 28L76 25L82 22Z\" fill=\"#EAF8FF\"/></svg></div><div class="q26info"><div class="q26nameLine"><div class="q26name"></div><span class="q299tag">'+HELP_NUMBER+'</span></div><div class="q26preview"></div></div><div class="q26right"></div>';
  ...
  setTimeout(()=>{ensureHelp();renderHelp();document.querySelectorAll('.small').forEach(el=>{if(/Skaysa\s+2\./i.test(el.textContent||''))el.textContent='Skaysa 2.9.9 • Android 8+';});},180);
})();